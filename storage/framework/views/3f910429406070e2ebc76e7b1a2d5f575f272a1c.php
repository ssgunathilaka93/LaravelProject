    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
		  ...
		  <li><a href="<?php echo e(url('admin/message')); ?>"><i class="fa fa-cog"></i> <span>Messages</span></a></li>
		  ...
		  <li><a href="<?php echo e(url(config('backpack.base.route_prefix', 'admin').'/page')); ?>"><i class="fa fa-file-o"></i> <span>Pages</span></a></li>
		  ...
		  <li><a href="<?php echo e(url('admin/audit')); ?>"><i class="fa fa-files-o"></i> <span>Audits</span></a></li>
		  <?php endif; ?>
		  <li><a href="<?php echo e(url('admin/tag')); ?>"><i class="fa fa-tag"></i> <span>Manage Tags</span></a></li>
		</ul>
      </section>
      <!-- /.sidebar -->
    </aside>
